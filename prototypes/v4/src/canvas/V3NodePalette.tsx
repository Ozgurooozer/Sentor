...
const NODES_ACTIVE: NodeDef[] = [
  { type: "terminal", label: "Terminal", desc: "PTY shell — OpenCode çalıştır", accent: "#4db89a", icon: IC("M3 4h10v8H3zM5 7l2 2-2 2M9 11h2") },
  { type: "input",    label: "Input",    desc: "Metin / değer girişi",          accent: "#5b8def", icon: IC("M3 8h10M9 4l4 4-4 4") },
  { type: "output",   label: "Output",   desc: "Wire çıktısını göster",         accent: "#a78bfa", icon: IC("M13 8H3M7 4l-4 4 4 4") },
];
