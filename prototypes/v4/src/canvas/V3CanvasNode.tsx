...
import { CANVAS_PANEL_MIN_H, CANVAS_PANEL_MIN_W } from "./constants";
import { useCanvasStore } from "@/store/canvasStore";
import type { CanvasPanelNode } from "@/store/types";

// ── Inline accent helper (replaces nodeAccent import) ───────────────────────
const NODE_ACCENT: Record<string, string> = {
  terminal: "#4db89a", editor: "#9b72ef", chat: "#5b8def", agent: "#5b8def",
  input: "#d4a843", checklist: "#888888", web: "#666666", "vault-home": "#666666",
  pipeline: "#e07b54", gallery: "#888888", codegraph: "#5b8def", preview: "#666666",
  canvas: "#444444", instance: "#444444", "canvas-3d": "#5b8def", logs: "#4db89a",
  gate: "#e07b54", variable: "#d4a843", "if-else": "#4db89a", "for-each": "#9b72ef",
  note: "#d4a843", sketch: "#888888", pipe: "#e07b54", filebrowser: "#666666", tool: "#5b8def",
};
function accentFor(panel: CanvasPanelNode): string {
  if ((panel.type as string) === "header") {
    const c = panel.meta?.headerColor;
    if (typeof c === "string" && c) return c;
    return "#d4a843";
  }
  return NODE_ACCENT[panel.type] ?? "#2a2a2a";
}
