...
- Auto-updater configured with a public minisign key; release artifacts at `https://github.com/atlas-ide/atlas/releases/latest/download/latest.json`.
